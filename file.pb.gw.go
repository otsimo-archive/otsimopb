...
/*
Package otsimopb is a reverse proxy.
...
func request_File_RequestStoreBig_0(ctx context.Context, marshaler runtime.Marshaler, client FileClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func request_File_Lookup_0(ctx context.Context, marshaler runtime.Marshaler, client FileClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterFileHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FileClient) error {
	...
	mux.Handle("POST", pattern_File_RequestStoreBig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_File_RequestStoreBig_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_File_RequestStoreBig_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_File_Lookup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_File_Lookup_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_File_Lookup_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_File_RequestStoreBig_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "file", "big"}, ""))

	pattern_File_Lookup_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "file", "lookup"}, ""))
)

var (
	forward_File_RequestStoreBig_0 = runtime.ForwardResponseMessage

	forward_File_Lookup_0 = runtime.ForwardResponseMessage
)
