...
const (
	STRING  AnalysisDataField_Type = 0
	INTEGER AnalysisDataField_Type = 1
	FLOAT   AnalysisDataField_Type = 2
	BOOL    AnalysisDataField_Type = 3
)
...
const (
	ASC QuerySort_SortOrder = 0
	DSC QuerySort_SortOrder = 1
)
...
const (
	NONE  Aggregation_Accumulator = 0
	COUNT Aggregation_Accumulator = 1
	SUM   Aggregation_Accumulator = 2
	MAX   Aggregation_Accumulator = 3
	MIN   Aggregation_Accumulator = 4
	AVG   Aggregation_Accumulator = 5
)
...
const (
	...
	Date QueryGroup_GroupType = 0
	// Datetime gives rows on given interval
	Datetime QueryGroup_GroupType = 1
	...
	TimeOfDay QueryGroup_GroupType = 2
	// Discrete should be used for String values
	Discrete QueryGroup_GroupType = 3
	// ContinuesInterval is for number values
	ContinuesInterval QueryGroup_GroupType = 4
)
...
const (
	MONTLY ActiveUsersRequest_Type = 0
	DAILY  ActiveUsersRequest_Type = 1
	NEW    ActiveUsersRequest_Type = 2
	TOTAL  ActiveUsersRequest_Type = 3
)
...
const (
	ONE    RetentionRequest_Type = 0
	SEVEN  RetentionRequest_Type = 1
	THIRTY RetentionRequest_Type = 2
)
...
var fileDescriptorAnalysis = []byte{
	...
	,
}
