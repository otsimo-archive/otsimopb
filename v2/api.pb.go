...
const (
	...
	AddProfileActionConstraint_UNIQUE_KIND AddProfileActionConstraint = 0
	// There can be only single action with same kind in edition of the profile
	AddProfileActionConstraint_UNIQUE_KIND_IN_EDITIONS AddProfileActionConstraint = 1
)

var AddProfileActionConstraint_name = map[int32]string{
	0: "UNIQUE_KIND",
	1: "UNIQUE_KIND_IN_EDITIONS",
}

var AddProfileActionConstraint_value = map[string]int32{
	"UNIQUE_KIND":             0,
	"UNIQUE_KIND_IN_EDITIONS": 1,
}
...
var fileDescriptor_9dd8ffb46251f1c6 = []byte{
	...
	,
}
