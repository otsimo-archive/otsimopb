...
func (*StatisticsReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f76cdcf45799bf4e, []int{0}
}
...
func (*StatisticsRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f76cdcf45799bf4e, []int{1}
}
...
func (dst *StatisticsRes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StatisticsRes.Merge(dst, src)
}
...
type UpdateProfileReq struct {
	...
	Profile              *otsimopb.Profile `protobuf:"bytes,2,opt,name=profile" json:"profile,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*UpdateProfileReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f76cdcf45799bf4e, []int{2}
}
...
func (dst *UpdateProfileReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateProfileReq.Merge(dst, src)
}
...
type UpdateChildReq struct {
	Fields               *types.FieldMask `protobuf:"bytes,1,opt,name=fields" json:"fields,omitempty"`
	Child                *otsimopb.Child  `protobuf:"bytes,2,opt,name=child" json:"child,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (*UpdateChildReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f76cdcf45799bf4e, []int{3}
}
...
func (dst *UpdateChildReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateChildReq.Merge(dst, src)
}
...
type UpdateProgressReq struct {
	...
	BadgesEarned         []*otsimopb.Badge `protobuf:"bytes,4,rep,name=badges_earned,json=badgesEarned" json:"badges_earned,omitempty"`
...
func (*UpdateProgressReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f76cdcf45799bf4e, []int{4}
}
...
func (dst *UpdateProgressReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateProgressReq.Merge(dst, src)
}
...
func init() { proto.RegisterFile("v2/api.proto", fileDescriptor_api_f76cdcf45799bf4e) }

var fileDescriptor_api_f76cdcf45799bf4e = []byte{
