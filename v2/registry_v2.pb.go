...
type GetAllGamesReq struct {
	...
	// Device Country
	DeviceCountry string `protobuf:"bytes,4,opt,name=device_country,json=deviceCountry,proto3" json:"device_country,omitempty"`
	// Device OS name
	DeviceOs string `protobuf:"bytes,5,opt,name=device_os,json=deviceOs,proto3" json:"device_os,omitempty"`
	// App edition
	AppEdition           string   `protobuf:"bytes,6,opt,name=app_edition,json=appEdition,proto3" json:"app_edition,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetAllGamesReq) GetDeviceCountry() string {
	if m != nil {
		return m.DeviceCountry
	}
	return ""
}

func (m *GetAllGamesReq) GetDeviceOs() string {
	if m != nil {
		return m.DeviceOs
	}
	return ""
...
func (m *GetAllGamesReq) GetAppEdition() string {
	if m != nil {
		return m.AppEdition
	}
	return ""
...
var fileDescriptor_3a1b22410eb3eeef = []byte{
	...
	,
}
...
func (m *GetAllGamesReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DeviceCountry) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintRegistryV2(dAtA, i, uint64(len(m.DeviceCountry)))
		i += copy(dAtA[i:], m.DeviceCountry)
	}
	if len(m.DeviceOs) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintRegistryV2(dAtA, i, uint64(len(m.DeviceOs)))
		i += copy(dAtA[i:], m.DeviceOs)
	}
	if len(m.AppEdition) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintRegistryV2(dAtA, i, uint64(len(m.AppEdition)))
		i += copy(dAtA[i:], m.AppEdition)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *GetAllGamesReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeviceCountry", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DeviceCountry = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppEdition", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AppEdition = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRegistryV2(dAtA[iNdEx:])
